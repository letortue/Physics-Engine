...
namespace Physics_Engine
{
    public class Rasterizer : IRenderEngine
    {
        ...
        */
        ...
        public void HandleMesh(Scene scene, double[] depths, byte[] pixels, Mesh mesh, Matrix4 inverse)
        {
            ...
            foreach (Triangle t in mesh.triangles)
            {
                ...
                HandleTriangle(scene, depths, pixels, t, inverse);
        ...
        public void HandleTriangle(Scene scene, double[] depths, byte[] pixels, Triangle t, Matrix4 inverse)
        {
            ...
            for (int k = 0; k < vertsClipped.Count; k++)
            {
                ...
                {
                            ProjectVertex(scene, vertsClipped[k][0]),
                            ProjectVertex(scene, vertsClipped[k][1]),
                            ProjectVertex(scene, vertsClipped[k][2])
                };
        ...
        public void ColorPixelTriangle(Scene scene, double[] depths, Vec3 point, byte[] pixels, Triangle t, double areab, double w0, double w1, double w2, Vec3 c0, Vec3 c1, Vec3 c2, Vec3[] vertices, int i, int j)
        {
        ...
        public double GetTotalLightIntensity(Scene scene, Vec3 point, SceneObject o, Vec3 normal)
        {
            double total = 0;
        ...
        public Vec3 ProjectVertex(Scene scene, Vec3 vertex)
        {
